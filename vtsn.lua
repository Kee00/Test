...
if _G.ChestBypass then
 ...
 local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Auto Kill BlackBeard", Default = false })
...
NotificationLibrary:SendNotification("Success", "Nhớ Đăng Ký Kênh Anh Jaki Nha", 8)