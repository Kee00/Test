...
task.spawn(function()
    ...
    local Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Auto Race V4", Default = false })
...
spawn(function()
    ...
    Toggle:OnChanged(function(Value)
        ...
        local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Pirates", Default = false })
...
spawn(function()
    ...
    local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Auto Kill Soul Reaper", Default = false })
...
local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Auto Buy Sword", Default = false})
...
spawn(function()
    ...
    local Toggle = Tabs.Se:AddToggle("MyToggle", {Title = "Lock Moon", Default = false })
...
local Toggle = Tabs.Se:AddToggle("MyToggle", {Title = "Tween To Gear", Default = false })
