...
NotificationLibrary:SendNotification("Warning", "Bật Fast Mode Để Có Một Trải Nghiệm Tốt", 10)
...
ImageButton.Image = "http://www.roblox.com/asset/?id=18619362009"
...
spawn(function()
    ...
    Tabs.Se:AddSection("Sea")
    
    local ToggleSeaBeAst = Tabs.Se:AddToggle("ToggleSeaBeAst", {Title = "Treo Vua Biển",Description = "', Default = false })
...
local ToggleAutoW = Tabs.Se:AddToggle("ToggleAutoW", {Title = "Tự Động Nhấn W",Description = "", Default = false })
...
NotificationLibrary:SendNotification("Success", "Load Thành Công", 8)