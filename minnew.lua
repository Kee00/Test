...
NotificationLibrary:SendNotification("Warning", "Chúc Bạn Một Trải Nghiệm Tốt", 10)
...
local Tabs = {
    ...
    Settings = Window:AddTab({ Title = "Setiing", Icon = "" }),
    stack = Window:AddTab({ Title = "Cày 3", Icon = "" }), 
    Se = Window:AddTab({ Title = "Quest Island", Icon = "" }),   
...
function RedeemCode(value)
	...
	Description = "",
	Callback = function()
 setclipboard("https://discord.gg/ng2PQFWbv4")
...
spawn(function()
    ...
    Tabs.Main:AddParagraph({
        Title = "Lưu Ý",
        Content = "Nếu Chỉnh Tốc Độ Bay Quá 300 Thì Có Thể Bị Lỗi"
    })
...
spawn(function()
    pcall(function()
      ...
      local ToggleEspKitsune = Tabs.Se:AddToggle("ToggleEspKitsune", {Title = "Định Vị Đảo Kitsune",Description = "", Default = false })
      ...
      local ToggleTPKitsune = Tabs.Se:AddToggle("ToggleTPKitsune", {Title = "Bay Đến Kitsune Island",Description = "", Default = false })
...
spawn(function()
    ...
    Tabs.Qs:AddSection("Nhiệm Vụ")
    
    local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Tự Động Lấy Saber", Default = false })
    ...
    local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Tự Động Cavender", Default = false})
...
local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Tự Động Cavender Đổi Server", Default = false})

Toggle:OnChanged(function(Value)
_G.Hop = Value
end) 

local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Tự Động Twin Hook", Default = false})
...
local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Tự Động Twin Hook Đổi Server", Default = false})

Toggle:OnChanged(function(Value)
_G.Hop = Value
end) 

local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Tự Động Mua Kiếm Huyền Thoại", Default = false})
...
local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Tự Động Lấy Yama", Default = false })
    ...
    local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Tự Động Lấy Tushita", Default = false })
...
spawn(function()
    ...
    local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Tự Động Song Kiếm", Default = false })
    ...
    local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Tự Động Soul Guitar", Default = false })
...
local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Tự Động Holy Torch", Default = false })
    ...
    local Toggle = Tabs.Se:AddToggle("MyToggle", {Title = "Treo Đảo Kì Bí", Default = false })
...
spawn(function()
    while wait() do
        ...
        local Toggle = Tabs.Se:AddToggle("MyToggle", {Title = "Bay Tới Đảo Kì Bí", Default = false })
    ...
    local Toggle = Tabs.Se:AddToggle("MyToggle", {Title = "Mở Khóa Trăng", Default = false })
...
NotificationLibrary:SendNotification("Success", "Tải Thành Công", 8)