...
NotificationLibrary:SendNotification("Warning", "Script New", 10)
...
textButton.BackgroundColor3 = Color3.fromRGB(34 , 139, 34) 
...
local soundId = "rbxassetid://18619362009" 
...
ImageButton.Image = "http://www.roblox.com/asset/?id=18678806757"
...
function RedeemCode(value)
	...
	Description = "Nhớ Đăng Ký Kênh Và Like Nhé",
	Callback = function()
 setclipboard("https://discord.gg/gf3rAfEayh")
...
task.spawn(function()
    ...
    local Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Auto V4", Default = false })
...
local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Farm Near Mob", Default = false })
...
spawn(function()
    ...
    local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Auto Quest Sea 2", Default = false })
...
local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Auto Quest Sea 3", Default = false })
    ...
    local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Kill Soul Reaper", Default = false })
...
spawn(function()
    ...
    Tabs.Main:AddSection("Special")
    local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Factory", Default = false })
    ...
    Toggle:OnChanged(function(Value)
        ...
        local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Kill Pirates", Default = false })
   ...
   Tabs.Main:AddSection("Farm Chest")
 
 local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Stop With Key or God Chalice", Default = true})
...
spawn(function()
 ...
 local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Chest Tween", Default = false})
...
spawn(function()
 ...
 Tabs.Main:AddSection("Farm Elite")
 ...
 Tabs.Main:AddSection("Raid Boss")
 local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Rip Indra", Default = false })
 ...
 local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Kill BlackBeard", Default = false })
 ...
 spawn(function()
    ...
    local CoNguoiDoiGietTao = Tabs.Main:AddToggle("MyToggle", {Title = "Starts Farm", Default = false })
...
Tabs.Main:AddSection("Estoplam")
local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Farm Estoplam", Default = false })
    ...
    local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Kill Boss", Default = false })
    ...
    spawn(function()
       ...
       Tabs.De:AddSection("Devil Fruits Tab")
    local Toggle = Tabs.De:AddToggle("MyToggle", {Title = "Spin Fruits", Default = false })
    ...
    local Toggle = Tabs.De:AddToggle("MyToggle", {Title = "Store Fruits", Default = false })
  ...
  "Leopard-Leopard"
    ...
    local Toggle = Tabs.De:AddToggle("MyToggle", {Title = "Buy Fruits", Default = false })
  ...
  pcall(function()
   ...
   game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("PurchaseRawFruit",_G.SelectFruit)
    ...
    local Toggle = Tabs.De:AddToggle("MyToggle", {Title = "Esp", Default = false })
    ...
    local Toggle = Tabs.De:AddToggle("MyToggle", {Title = "Tween To Fruits", Default = false })
...
local Toggle = Tabs.raid:AddToggle("MyToggle", {Title = "Auto Awakening", Default = false })
    Toggle:OnChanged(function(Value)
...
game:GetService("TeleportService"):TeleportToPlaceInstance(game.placeId,_G.Job, game.Players.LocalPlayer)
  ...
  local Value = game:GetService("VirtualUser")
	...
	Tabs.Lc:AddSection("Teleport Island")
...
"Tiki Outpost"},
    ...
    local Toggle = Tabs.Lc:AddToggle("MyToggle", {Title = "Tween To Island", Default = false })
...
local Toggle = Tabs.RC:AddToggle("MyToggle", {Title = "Auto Trial", Default = false })
...
spawn(function()
    pcall(function()
      ...
      local ToggleEspKitsune = Tabs.Se:AddToggle("ToggleEspKitsune", {Title = "Esp Kitsune",Description = "", Default = false })
    ...
    Tabs.Qs:AddSection("Item")
    
    local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Auto Saber", Default = false })
    ...
    local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Auto Cavender", Default = false})
...
local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Auto Twin Hook", Default = false})
...
local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Auto Buy Sword Lengendary", Default = false})
...
local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Auto Yama", Default = false })
...
local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Auto Holy Torch", Default = false })
    ...
    local Toggle = Tabs.Se:AddToggle("MyToggle", {Title = "Summon Mirage Island", Default = false })
...
Tabs.spl:AddSection("Auto Stats")
...
spawn(function()
    while wait() do
        ...
        local Toggle = Tabs.Se:AddToggle("MyToggle", {Title = "Tween To Mirage Island", Default = false })
...
NotificationLibrary:SendNotification("Success", "VTSN On Top", 8)